...
import { addBucketlist } from "../../actions/profileActions";
...
class AddBucketlist extends Component {
  ...
  onSubmit(e) {
    ...
    this.props.addBucketlist(eduData, this.props.history);
  }
